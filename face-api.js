    ...
    ***************************************************************************** */
    ...
    function drawDetections(canvasArg, detections) {
        ...
        detectionsArray.forEach(function (det) {
            ...
            var label = score ? "" + round$1(score) : undefined;
            new DrawBox(box, { label: label }).draw(canvasArg);
        });
    }
    function drawAge(canvasArg, detections) {
        var detectionsArray = Array.isArray(detections) ? detections : [detections];
        detectionsArray.forEach(function (det) {
            var label = det.age ? "" + Math.floor(det.age)+ " ans" : undefined;
            var anchor = det.detection.box.bottomRight
            var drawTextField = new DrawTextField(label, anchor);
            drawTextField.draw(canvasArg);
        });
    }

    function drawName(canvasArg, detections) {
        var detectionsArray = Array.isArray(detections) ? detections : [detections];
        detectionsArray.forEach(function (det) {
            var label = det.name ? det.name : undefined;
            var anchor = det.detection.box.top
            var drawTextField = new DrawTextField(label, anchor);
            drawTextField.draw(canvasArg);
        });
    }

    function drawGender(canvasArg, detections) {
        var detectionsArray = Array.isArray(detections) ? detections : [detections];
        detectionsArray.forEach(function (det) {
            var label = det.name ? det.name : det.gender;
            var anchor = det.detection.box.topRight
            var drawTextField = new DrawTextField(label, anchor);
            drawTextField.draw(canvasArg);
        });
    }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            out = _a.sent();
                            return [4 /*yield*/, Promise.all(unstack(out).map(function (t) { return __awaiter(_this, void 0, void 0, function () {
                                    var data;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
    ...
    function drawFaceExpressions(canvasArg, faceExpressions, minConfidence, textFieldAnchor) {
        ...
        faceExpressionsArray.forEach(function (e) {
            ...
            var drawTextField = new DrawTextField(resultsToDisplay.map(function (expr) { return expr.expression + " (" + round$1(expr.probability) + ")"; }), anchor);
            drawTextField.draw(canvasArg);
        });
    }
    ...
    function extractParams$3(weights, numMainBlocks) {
        ...
        var middle_flow = {};
        range$1(numMainBlocks, 0, 1).forEach(function (idx) {
    ...
    function conv(x, params, stride) {
        return add(conv2d(x, params.filters, stride, 'same'), params.bias);
    }
    function reductionBlock(x, params, isActivateInput) {
        if (isActivateInput === void 0) { isActivateInput = true; }
        var out = isActivateInput ? relu(x) : x;
        out = depthwiseSeparableConv$1(out, params.separable_conv0, [1, 1]);
        out = depthwiseSeparableConv$1(relu(out), params.separable_conv1, [1, 1]);
        out = maxPool(out, [3, 3], [2, 2], 'same');
        out = add(out, conv(x, params.expansion_conv, [2, 2]));
        return out;
    }
    function mainBlock(x, params) {
        var out = depthwiseSeparableConv$1(relu(x), params.separable_conv0, [1, 1]);
        out = depthwiseSeparableConv$1(relu(out), params.separable_conv1, [1, 1]);
        out = depthwiseSeparableConv$1(relu(out), params.separable_conv2, [1, 1]);
        out = add(out, x);
        return out;
    }
    var TinyXception = /** @class */ (function (_super) {
        ...
        TinyXception.prototype.forwardInput = function (input) {
            ...
            return tidy(function () {
                ...
                range$1(_this._numMainBlocks, 0, 1).forEach(function (idx) {
                    out = mainBlock(out, params.middle_flow["main_block_" + idx]);
                });
                out = reductionBlock(out, params.exit_flow.reduction_block);
                out = relu(depthwiseSeparableConv$1(out, params.exit_flow.separable_conv, [1, 1]));
                return out;
            });
        };
    ...
    var AgeGenderNet = /** @class */ (function (_super) {
        ...
        AgeGenderNet.prototype.forwardInput = function (input) {
            ...
            return tidy(function () {
                ...
                return { age: age, gender: softmax(gender) };
            });
        };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!(input instanceof Tensor)) return [3 /*break*/, 2];
